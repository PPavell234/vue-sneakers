...
<template>
    <div>
        ...
        <div
            ...
            <!-- Левая колонка -->
            <div
                class="flex flex-col items-center text-center bg-[#33302F] p-6 rounded-2xl shadow-md w-full  md:w-[250px]">
            ...
            <div class="space-y-4 max-w-[900px]">
                ...
                <p>
                    Introducing SoulSteel – an ever-expanding multiplayer dungeon crawler from Noxcrew where every
                    corner
                    holds a
                ...
                <p>
                    In SoulSteel, you assume the role of a daring, gear-craving relic hunter with the sole mission of
                    exploring
                    treacherous dungeons in the pursuit of glory and treasure. Your spoils give you resources and
                    materials
                    that
                    allow you to evolve your character, unlock new abilities, grow in strength, and take on even tougher
                    challenges.
                    The more you extract, the better the rewards!
                </p>

                <p>
                    Time is your greatest enemy. Or well, one of many enemies, actually! The undiscovered challenges
                    held
                    within
                    these dungeons will test even the most seasoned adventurer with perplexing puzzles, treacherous
                    traps,
                    and
                ...
                <p>
                    But with risk comes the promise of rewards! Fortune favours the bold – those that venture the
                    deepest
                    will get
                    greater rewards, and more plentiful resources. And better gear is an absolute necessity if you plan
                    on
        ...
        <div class="text-white bg-[#262423] min-h-screen p-4 md:p-10 flex justify-center">
            <div class="max-w-[900px] space-y-4">
                ...
                <p>
                    However, linger too long and you’ll have to deal with the consequences. If you don’t make it back in
                    time, you
                    will be trapped inside, losing a percentage of your hard-earned rewards in the process, all for
                    naught!
                </p>

                <p>
                    Your dungeon starts with very little time available, meaning that short, cautious trips are a
                    preferable
                    approach. Luckily, there’s ‘Chrono Essence’ – a mysterious substance used to level up your Chrono
                    Keeper
                    lantern.
                </p>

                <p>
                    Not all your time is spent spelunking those structures. Port Fortuna, a hub for both you and other
                    fellow
                ...
                <p>WHAT’S NEXT?</p>
                <p>
                    SoulSteel is meant to be an evolving experience that will only grow over time. This means that more
                    updates are
                    on the horizon.
                </p>

                <p>
                    “With SoulSteel, we've found gameplay that we find fun, and we can't stop playing! We have so many
                    cool
                    plans
                    and ideas for where we want to take the journey, and we can't wait to share them with you!” says
                    Noxcrew’s Joe
                    Arsenault.
                </p>

                <p>
                    So who's ready for some dungeons? Personally, I'm souled! You can find SoulSteel in the Servers tab
                    on
                    Minecraft
