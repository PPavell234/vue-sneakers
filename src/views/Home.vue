...
<template>
    ...
    <div
        ...
        <div class="space-y-4 max-w-[900px]">
            ...
            <p>
                Introducing SoulSteel – an ever-expanding multiplayer dungeon crawler from Noxcrew where every corner
                holds a
            ...
            <p>
                ...
                exploring
                treacherous dungeons in the pursuit of glory and treasure. Your spoils give you resources and materials
                that
            ...
            <p>
                Time is your greatest enemy. Or well, one of many enemies, actually! The undiscovered challenges held
                within
                these dungeons will test even the most seasoned adventurer with perplexing puzzles, treacherous traps,
                and
                mighty mobs hungry for a fight – all with the ability to end your journey suddenly and swiftly.
            </p>

            <p>
                But with risk comes the promise of rewards! Fortune favours the bold – those that venture the deepest
                will get
    ...
    <div class="text-white bg-[#262423] min-h-screen p-4 md:p-10 flex justify-center">
        <div class="max-w-[900px] space-y-4">
            ...
            <p>
                “With SoulSteel, we've found gameplay that we find fun, and we can't stop playing! We have so many cool
                plans
            ...
            <p>
                So who's ready for some dungeons? Personally, I'm souled! You can find SoulSteel in the Servers tab on
                Minecraft
